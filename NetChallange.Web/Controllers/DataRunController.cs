...
{
    public class DataRunController : BaseController
    {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    foreach (var json in jsonList.ToList())
                    {
                        ...
                        contact.AddressId = contactAddress.Id;
                    ...
                    UnitOfWork.AddressRepository.AddRange(addressList);
                    UnitOfWork.CompanyRepository.AddRange(companyList);
                    UnitOfWork.ContactRepository.AddRange(contactList);
                    UnitOfWork.Commit();
                }
